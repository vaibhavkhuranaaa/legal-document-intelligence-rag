...
well-structured Python packages.
...
baseline. See `docs/roadmap.md` for the forward plan.
...
- *Metadata preservation:* Best possible - HTML's actual semantic tags
  ...
  documented heuristic limitations in `docs/architecture.md`.
...
This drift required an explicit decision before RAG layers were built.
