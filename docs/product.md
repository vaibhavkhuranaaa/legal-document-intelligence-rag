...
standards and workflow live in the repository documentation; architecture and technical
...
demonstrate disciplined AI engineering practices: retrieval-augmented
...
Large transactional legal documents, including merger agreements, purchase
agreements, and proxy statements, are long, dense, and difficult to search. Legal
...
**SEC EDGAR transaction documents (current validated corpus, native HTML):**
...
- Reproducible, tested repository
- Reproducible setup
- Automated testing
- CI pipeline
- Azure deployment
...
Not committed scope. Candidate directions after the current public workspace:
...
- Contract comparison
- Risk scoring
- Attorney-reviewed answer and citation-correctness evaluation
- Authenticated matter isolation and private-data controls
